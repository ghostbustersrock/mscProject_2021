...
class ActivitiesTab: UIViewController {
    ...
    @IBAction func walkingFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[0].currentImage!
    ...
    @IBAction func runningFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[1].currentImage!
    ...
    @IBAction func newSportFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[2].currentImage!
    ...
    @IBAction func yogaFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[3].currentImage!
    ...
    @IBAction func meditationFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[4].currentImage!
    ...
    @IBAction func dancingFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[5].currentImage!
    ...
    @IBAction func singingFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[6].currentImage!
    ...
    @IBAction func musicFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[7].currentImage!
    ...
    @IBAction func journalFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[8].currentImage!
    ...
    @IBAction func aloneTimeFunc(_ sender: Any) {
        ...
        let imageActivity = activitiesButton[9].currentImage!
